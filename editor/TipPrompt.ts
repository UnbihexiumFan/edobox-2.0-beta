		...
		switch (type) {
			case "scale": {
				message = div(
					...
					p("Scale names for the heptatonic and octatonic scales are taken from the Xenharmonic Wiki (https://en.xen.wiki), or by taking the names from there and adding the prefix \"anti-\". Scale names for pentatonic scales are taken from corresponding modes of the heptatonic/octatonic scales and suffixed with \"Pentatonic\".")
				);
			} break;
			case "key": {
				message = div(
